...
export class InvoicesController {
  ...
  summary(@CurrentUser() user: any) {
    return this.invoicesService.summary(user.userId);
  }

  @Get("receivables")
  receivables(@CurrentUser() user: any) {
    return this.invoicesService.receivables(user.userId);
  }
  ...
  updateStatus(
    ...
    return this.invoicesService.updateStatus(user.userId, id, dto);
  }
